...
def update_event(event_id, event_name=None, contract_id=None, event_date_start=None, event_date_end=None, location=None, attendees=None, notes=None, token=None):
    headers = {
        'Authorization': f'Bearer {token}',
        'Content-Type': 'application/json'
    }
